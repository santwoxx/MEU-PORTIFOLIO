...
function initFluid() {
    ...
    const displayShaderSource = `
        ...
        void main () {
          ...
          // Saida como preto com a opacidade correspondente
    ...
    function updatePointerMoveData(pointer, posX, posY, color) {
        ...
        pointer.color = color;
        // Evita desenhar o fluido sobre o rosto/corpo do robô
        const inFaceZone = (posX > canvas.width * 0.35 &&
            posX < canvas.width * 0.65 &&
            posY > canvas.height * 0.35);
        if (inFaceZone) {
            pointer.moved = false;
        }
    }
    ...
    function generateColor() {
        // Retornamos branco puro (que depois no display será desenhado como preto)
